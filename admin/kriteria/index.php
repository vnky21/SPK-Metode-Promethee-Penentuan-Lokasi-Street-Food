...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        ...
        <h1 class="app-page-title mb-1 mt-3">Data Kriteria</h1>
        <p class="mb-4">Data Kriteria merupakan parameter yang digunakan untuk mengevaluasi dan membandingkan berbagai alternatif.</p>
        ...
        <div class="app-card app-card-chart h-100 shadow-sm">
            <div class="app-card-header p-3">
                <div class="row justify-content-between align-items-center">
                    <div class="col-auto">
                        <h4 class="app-card-title">Data Kriteria - SPK Promethee</h4>
                    </div>
                    <!--//col-->
                    <div class="col-auto">
                ...
                <div class="table-responsive">
                    <table class="table app-table-hover mb-0 text-left display" id="myTable">
                        <thead>
                            <tr>
                                <th class="cell">No</th>
                                <th class="cell">Nama Kriteria</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="cell"><?= $i++ ?>.</td>
                                <td class="cell"><?= $value->nama_kriteria; ?></td>
                                <td class="cell">
                                    <a class="btn app-btn-primary"
                                        href="form.php?action=edit&id=<?= encryptID($value->id_kriteria); ?>"><i
                                            class="fa fa-edit"></i></a>
                                    <button class="btn app-btn-danger btn-delete"
                                        id="<?= encryptID($value->id_kriteria); ?>"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
